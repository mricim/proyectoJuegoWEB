...
<main class="container" role="main" style="padding-bottom: 70px;">
            ...
            <div class="row justify-content-md-center">
                <div class="row">
                    ...
                    <div id="resultMail">
                        ...
                        <!--</b>!<br/>
                            An email has been sent to you, please check your email: <b>
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <div class="containter">
            <form action="/includes/reCaptcha/postlogincall.php" id="comment_form" method="POST">
                <div class="row">
                    ...
                    <br><br>
                    <input aria-label="email" class="form-control col-10 col-lg-4 offset-1" id="user"
                           name="user" placeholder="Name User" type="text">
                ...
                <div class="row" style="margin-top: 20px; margin-left: 45%;">
                    <button class="btn btn-outline-success" disabled id="button_sender" name="button_sender"
...
<link rel="import" href="\example\add\91js.html" onload="handleLoad(event)" onerror="handleError(event, this.href)">
</body>

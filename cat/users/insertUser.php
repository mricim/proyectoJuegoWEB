...
$links = conectar_db();
        ...
        if ($exists == 1) {
            ...
            if (isset($result_mensaje) == FALSE) {
            	...
            	echo "<script> window.location='../../../cat/users/registerdone.html?AddedUser=error'; </script>";
            } else {
                echo "<br>Result mensaje: ".$result_mensaje."<br>";
            	echo"<br>Se a guardado en nuestra base de datos<br>";
            	echo"<br><b>Todo correcto</b><br>";
            	//exit();
            	echo "<script> window.location='../../../cat/users/registerdone.html?AddedUser=true'; </script>";
            }
        } else {
            echo "<script> window.location='../../../cat/users/registerdone.html?AddedUser=false'; </script>";
        }
